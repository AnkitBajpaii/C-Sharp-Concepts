...
namespace CustomCollectionDemo2
{
    ...
    class Program
    {
        ...
        {
            Employee emp1 = new Employee { Name="A",Age=20};
            Employee emp2 = new Employee { Name = "B", Age = 20 };
            Employee emp3 = new Employee { Name = "C", Age = 20 };
            Employee emp4 = new Employee { Name = "D", Age = 20 };
